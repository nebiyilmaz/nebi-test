...
use Divido\Routing\Activation\GetRoutes;
...
class GetRoutesTest extends RouteTestCase
{
    ...
    public function test_GetOne_Success()
    {
        ...
        self::assertSame($mockModel->getDeliveryMethod(), $data->delivery_method);
        self::assertSame($mockModel->getTrackingNumber(), $data->tracking_number);
